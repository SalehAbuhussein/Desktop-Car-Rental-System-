...
namespace Cars_Rental.Payment.Views
{
    public partial class viewPayment : UserControl
    {
        ...
        private void LoadPayments()
        {
            ...
            string selectedFilter = cbTypeFilter.SelectedItem.ToString();

            if (selectedFilter != "All")
            {
                dt = clsCarRentalPayment.GetRentalPaymentsDataByType(1, 10, selectedFilter);
                _ActiveFilter = cbTypeFilter.SelectedItem.ToString();
            } else
            {
                dt = clsCarRentalPayment.GetRentalPaymentsData(1, 10);
                _ActiveFilter = "All";
            }
        ...
        {
            int paymentID = Convert.ToInt32(((Guna2Button)sender).Tag);
            ...
            guna2MessageDialog1.Show(
                $"View Payment Details: #{paymentID}",
                "Payment Details"
            );

            // TODO:
            // Open payment details form here.
            //
            // Example:
        ...
        {
            if (_ActiveFilter == cbTypeFilter.SelectedItem.ToString())
            {
                return;
            }
